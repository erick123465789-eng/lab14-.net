...
namespace lab10erick.Infrastructure.Context;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=localhost;Port=5433;Database=ticketera_db;Username=postgres;Password=root123");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Response>(entity =>
        {
            ...
            entity.HasIndex(e => e.TicketId, "idx_responses_ticket_id");
        ...
        modelBuilder.Entity<Ticket>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "idx_tickets_user_id");
